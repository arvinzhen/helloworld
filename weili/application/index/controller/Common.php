...
class Common extends Controller{
    ...
    protected function initialize(){
        ...
        $this->assign('xianshi',$this->xianshi);
        if(empty($res)){
        ...
        //$data[0]['coin'] = "<ul class='buxianshi xia-nav'><li><a href='/index/abouts'>公司简介</a></li><li><a href='/index/abouts/culture.html'>企业文化</a></li><li><a href='/index/abouts/honor.html'>荣誉资质</a></li></ul>";
