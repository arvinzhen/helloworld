...
<body class="login-bg">
    <div class="login layui-anim layui-anim-up">
        ...
        <form class="layui-form" >
            ...
            <img id="verifycode" src="{:url('admin/index/verify')}" onclick="shuaxin()" alt="captcha" /></div>
            <hr class="hr15">
            ...
            <hr class="hr20" >
            <div class="layui-input-inline">
            	<?php if($mz){echo "<p>您已经登入,<a href='".url('admin/index/index')."'>点击直达管理页面</a></p>";} ?>
            </div>
        </form>
    </div>
    ...
    <script>
        function shuaxin(){
            document.getElementById("verifycode").src='{:url('admin/index/verify')}?d'+Math.random();
        }
    </script>
    <!-- 底部结束 -->
</body>
