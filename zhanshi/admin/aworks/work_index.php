<?php 
    ...
    $condition = "";
    if(!$search){
        $sql = "select id,name,classid,visit,releasetime from aworks order by id asc".$limit;
    }else{
        $condition = substr($search,3);
        $sql = "select id,name,classid,visit,releasetime from aworks where".$condition." order by id asc".$limit;
    }
    // ohno($search);
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加用户','/admin/aworks/work_add.php',800,600)"><i class="layui-icon"></i>添加</button>
                </div>
                ...
                <?php if($res){bottomNav("aworks","work_index.php",$curPage, $condition);} ?>
            </div>
        </div>
    </div>
</div> 
