<?php include("../../zhanshi.php");
    checkLogin();
    $sql = "select name,sontype from classes where type=1 and classid=0";
    ...
    if($res){
      ...
      $str .= "<option>去主页加类别,否则无法添加</option>";
    }
?>
<!DOCTYPE html>
        ...
        <div class="layui-row">
            <form class="layui-form">
              <div class="layui-form-item layui-inline">
                ...
                <div class="layui-form-item layui-inline">
                  <select name="sontype" class="" id="sontype" style="width: 190px;height:30px;display: inline;">
                    <?php echo $str; ?>
                  </select>
                </div>
                <div class="layui-input-inline">
...
<script>
    ...
    var sontype = $('#sontype option:selected').val();
		$.ajax({
			...
			method:'POST',
			data:{'title':title, 'html':html, 'sontype':sontype},
			dataType:'json',
