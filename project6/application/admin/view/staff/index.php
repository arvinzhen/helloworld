                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" method="GET" action="{:url('@admin/staff/index')}">
                    ...
                    {eq name='pz' value='1'}
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','{:url('admin/staff/create')}','','')"><i class="layui-icon"></i>添加</button>
                        </div>
                        <div class="layui-card-body ">
                            ...
                            {volist name='res' id='data'}
	                                <tr>
	                                  ...
	                                  <td class="cz">
	                                    <a href="<?php echo url('@admin/staff/read/'.$data['classid']); ?>"  title="详情">
	                                      <i class="iconfont">&#xe6a4;</i>
	                                    </a></td><td class="cz">
	                                    <a title="编辑"  onclick="xadmin.open('编辑','{:url('@admin/staff/edit/'.$data.classid)}')" href="javascript:;">
