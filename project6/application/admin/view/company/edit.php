				...
				<form class="layui-form">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                      <select name="type" id="type" lay-verify="leibie" lay-filter="test" class="layui-select">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="title" name="title" required="" lay-verify="required" autocomplete="off" class="layui-input" disabled value="{$data.title}">
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label class="layui-form-label">
        ...
        <script>
            ...
            function() {
                ...
                form.on('select(test)',function(data){
                  $("#title").val(data.elem.selectedOptions[0].innerText);
                });                //监听提交
                form.on('submit(add)',
                function(data) {
                  ...
                  data.field.oldpid = {$id};
                    //发异步，把数据提交给php
                    $.ajax({
                    	url:"{:url('@admin/company/update/'.$data['classid'])}"
                    	,method:'POST'
                    	,data:data.field
                    	,dataType:'json'
