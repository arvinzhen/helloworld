    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                ...
                <form class="layui-form">
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                        <select name="title" id="title" class="layui-select">
                          {volist name="data" id="v" empty="<option value='0'>当前为空</option>"}
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-block" id="xianshi">
					      ...
					      <input type="radio" name="hasimg" lay-filter="hasimg" value="0" title="否" checked>
					  </div>
                  </div>
                  <div class="layui-form-item yes" id="bucun">
                  ...
                  <div class="layui-form-item no" id="cun">
                  	<label class="layui-form-label">
              ...
              <div id="huala" class="layui-form-item no">
                  <label for="L_repass" class="layui-form-label">
                  </label>
        ...
        <script>
          function checklb(){
            if($("#title").val() == 0){
              layer.msg("类别没选!",{icon:2,time:1200});return false;
            }
          }
        </script>
      </body>
