...
<html class="x-admin-sm">
			...
			<div class="layui-form">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<select name="toptitle" id="toptitle" lay-verify="leibie" class="layui-select">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="sontitle" class="layui-input" required lay-verify="required" value="{$data.title}">
					</div>
				</div>
				<div class="layui-form-item">
	...
	<script>
		$(document).ready(function(){
			$("#toptitle > option").eq({$data.type}).prop("selected",true);
		})
	</script>
	<script>
		layui.use(['form','layer'],function(){
			...
			form.on('submit(add)',function(data){
				...
				$.ajax({
					url:'{:url('@admin/classes/update/'.$data['id'])}'
					,method:'POST'
					,data:data.field
					,dataType:'json'
