        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加产品','<?php echo site_url('admin/product/add'); ?>','','')"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
...
<script>
    ...
    function delAll () {
        ...
        layer.confirm('确认要删除吗？'+arr,function(){
            //捉到所有被选中的，发异步进行删除
            $.ajax({
                url:'<?php echo site_url('admin/product/delete'); ?>'
                ,data:{'ids':arr}
                ,method:'POST'
                ,dataType:'json'
