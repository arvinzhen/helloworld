...
<html class="x-admin-sm">
    <head>
        ...
        <link rel="stylesheet" href="/public/css/theme5.css">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="<?php echo site_url('hj'); ?>">盛光宏机</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('个人信息','<?php echo site_url('admin/users/detail'); ?>','600','600')">个人信息</a></dd>
                        <dd>
                            <a onclick="xadmin.open('切换帐号','<?php echo site_url('login'); ?>','800','800')">切换帐号</a></dd>
                        <dd>
                            <a href="./login.html">退出</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item to-index">
                    <a href="<?php echo site_url('hj'); ?>">前台首页</a></li>
            </ul>
        </div>
        <!-- 顶部结束 -->
        <!-- 中部开始 -->
        ...
        <div class="left-nav">
            <div id="side-nav">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('类别表', '<?php echo site_url('admin/classes'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>类别管理</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('统计页面','<?php echo site_url('admin/users'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>统计页面</cite></a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('管理小标题','<?php echo site_url('admin/about'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>总览页面</cite></a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('加工工艺','<?php echo site_url('admin/works'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>页面总览</cite>
                        </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('产品中心', '<?php echo site_url('admin/product'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>页面总览</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('资讯分类','<?php echo site_url('admin/news'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>新闻分类</cite>
                            </a>
                        </li>
                        <li><a onclick="xadmin.add_tab('资讯中心', '<?php echo site_url('admin/news'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>潮流一览</cite>
                        </a></li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('留言', '<?php echo site_url('admin/message'); ?>')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>留言表</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('sysSet', '/zhanshi/admin/sysset/sysset_index.php')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>主要设置</cite>
                            </a>
                        </li>
            ...
            <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src='<?php echo site_url('admin/allin/welcome'); ?>' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                    </div>
                </div>
                <div id="tab_show"></div>
            </div>
