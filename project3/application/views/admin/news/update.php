...
<div class="layui-main">
    <div class="layui-row">
        <form class="layui-form">
            <h1><label class="layui-form-label"></label>新闻修改页面</h1>
            ...
            <div class="layui-form-item layui-inline">
                <script id="uecontainer" name="content" type="text/plain"><?php echo $content; ?>
                </script>
                <!-- 配置文件 -->
...
<script>
    ...
    function() {
        ...
        function(data) {
            ...
            $.ajax({
                url:"<?php echo site_url('admin/news/update_save'); ?>"
                ,method:'POST'
                ,data:data.field
                ,dataType:'json'
