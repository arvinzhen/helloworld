...
<body>
    <div class="x-nav">
        ...
        <a href="http://hj.com/admin/users">用户中心</a>
        <a>
            <cite>用户总览</cite></a>
        </span>
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-header">
                        ...
                        <button class="layui-btn" onclick="xadmin.open('添加用户','<?php echo site_url('admin/users/add'); ?>',600,400)"><i class="layui-icon"></i>添加</button>
                    </div>
